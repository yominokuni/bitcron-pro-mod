...
`
  ...
  // 用到的库
  const LIBS = [
    '你的主页域名url/media/live2d/pio.css',
    '你的主页域名url/media/live2d/TweenLite.js',
    '你的主页域名url/media/live2d/live2dcubismcore.min.js',
    '你的主页域名url/media/live2d/pixi.min.js',
    '你的主页域名url/media/live2d/cubism4.min.js',
    '你的主页域名url/media/live2d/pio_sdk4.js',
    '你的主页域名url/media/live2d/pio.js'
  ]
...
//   hidden:false,
    content: {
      ...
      skin: ["诶，想看看其他团员吗？", "来咯~"], // 0更换模型提示文案  1更换完毕入场文案
        custom: [// 鼠标移上去提示元素
...
//   夜间模式控件
  night: "toggleNightMode()",
    model: [
      // 待加载的模型列表
 "https://akaito.xyz/media/live2d/Diana.model3.json",
      "https://akaito.xyz/media/live2d/Ava.model3.json",
    ],
    tips: true, // 时间问好
